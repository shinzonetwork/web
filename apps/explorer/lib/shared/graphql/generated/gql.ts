...
const documents: Documents = {
    "\n  query BlockTransactionsCount($blockNumber: Int) {\n    BlockTransactionsCount: Ethereum__Mainnet__Block(\n      filter: { number: { _eq: $blockNumber } }\n      limit: 1\n    ) {\n      transactions (order: { transactionIndex: DESC }, limit: 1) {\n        transactionIndex\n      }\n    }\n  }\n": types.BlockTransactionsCountDocument,
    "\n  query BlockTransactionsCountByHash($blockHash: String!) {\n    BlockTransactionsCount: Ethereum__Mainnet__Block(\n      filter: { hash: { _eq: $blockHash } }\n      limit: 1\n    ) {\n      transactions (order: { transactionIndex: DESC }, limit: 1) {\n        transactionIndex\n      }\n    }\n  }\n": types.BlockTransactionsCountByHashDocument,
    "\n  query BlockTransactions($offset: Int, $limit: Int, $blockNumber: Int) {\n    BlockTransactions: Ethereum__Mainnet__Block(\n      filter: { number: { _eq: $blockNumber } }\n      limit: 1\n    ) {\n      timestamp\n      transactions (offset: $offset, limit: $limit) {\n        hash\n        from\n        to\n        value\n        gasPrice\n      }\n    }\n  }\n": types.BlockTransactionsDocument,
    "\n  query BlockTransactionsByHash($offset: Int, $limit: Int, $hash: String!) {\n    BlockTransactions: Ethereum__Mainnet__Block(filter: { hash: { _eq: $hash } }, limit: 1) {\n      timestamp\n      transactions (offset: $offset, limit: $limit) {\n        hash\n        from\n        to\n        value\n        gasPrice\n      }\n    }\n  }\n": types.BlockTransactionsByHashDocument,
    "\n  query Block($number: Int!) {\n    Block: Ethereum__Mainnet__Block(filter: { number: { _eq: $number } }, limit: 1) {\n      hash\n      number\n      timestamp\n      parentHash\n      difficulty\n      totalDifficulty\n      gasUsed\n      gasLimit\n      baseFeePerGas\n      nonce\n      miner\n      size\n      stateRoot\n      sha3Uncles\n      transactionsRoot\n      receiptsRoot\n      logsBloom\n      extraData\n      mixHash\n    }\n  }\n": types.BlockDocument,
    "\n  query BlockByHash($hash: String!) {\n    Block: Ethereum__Mainnet__Block(filter: { hash: { _eq: $hash } }, limit: 1) {\n      hash\n      number\n      timestamp\n      parentHash\n      difficulty\n      totalDifficulty\n      gasUsed\n      gasLimit\n      baseFeePerGas\n      nonce\n      miner\n      size\n      stateRoot\n      sha3Uncles\n      transactionsRoot\n      receiptsRoot\n      logsBloom\n      extraData\n      mixHash\n    }\n  }\n": types.BlockByHashDocument,
    "\n  query Blocks($offset: Int, $limit: Int) {\n    Block: Ethereum__Mainnet__Block(offset: $offset, limit: $limit, order: { number: DESC }) {\n      number\n      timestamp\n      gasUsed\n      gasLimit\n      miner\n      transactions(limit: 1, order: { transactionIndex: DESC }) {\n        transactionIndex\n      }\n    }\n  }\n": types.BlocksDocument,
    "\n  query ShortBlocks($limit: Int) {\n    Block: Ethereum__Mainnet__Block(\n      limit: $limit, \n      order: { number: DESC }\n    ) {\n      number\n      miner\n      timestamp\n      transactions(limit: 1, order: { transactionIndex: DESC }) {\n        transactionIndex\n      }\n    }\n  }\n": types.ShortBlocksDocument,
    "\n  query ShortTransactions($limit: Int) {\n    Transaction: Ethereum__Mainnet__Transaction(\n      limit: $limit, \n      order: { blockNumber: DESC }\n    ) {\n      hash\n      from\n      to\n      value\n    }\n  }\n": types.ShortTransactionsDocument,
    "\n  query AttestationsCount($docId: String!) {\n    Attestation: Ethereum__Mainnet__AttestationRecord(filter: {attested_doc: {_eq: $docId}}) {\n        count: vote_count\n    }\n  }\n": types.AttestationsCountDocument,
    "\n  query TransactionLogs($hash: String) {\n    Logs: Ethereum__Mainnet__Log(\n      filter: { transactionHash: { _eq: $hash } }\n      order: [{ logIndex: ASC }]\n    ) {\n      logIndex\n      address\n      topics\n      data\n      transactionHash\n      blockNumber\n    }\n  }\n": types.TransactionLogsDocument,
 ...
 */
export function graphql(source: "\n  query BlockTransactionsCount($blockNumber: Int) {\n    BlockTransactionsCount: Ethereum__Mainnet__Block(\n      filter: { number: { _eq: $blockNumber } }\n      limit: 1\n    ) {\n      transactions (order: { transactionIndex: DESC }, limit: 1) {\n        transactionIndex\n      }\n    }\n  }\n"): typeof import('./graphql').BlockTransactionsCountDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query BlockTransactionsCountByHash($blockHash: String!) {\n    BlockTransactionsCount: Ethereum__Mainnet__Block(\n      filter: { hash: { _eq: $blockHash } }\n      limit: 1\n    ) {\n      transactions (order: { transactionIndex: DESC }, limit: 1) {\n        transactionIndex\n      }\n    }\n  }\n"): typeof import('./graphql').BlockTransactionsCountByHashDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query BlockTransactions($offset: Int, $limit: Int, $blockNumber: Int) {\n    BlockTransactions: Ethereum__Mainnet__Block(\n      filter: { number: { _eq: $blockNumber } }\n      limit: 1\n    ) {\n      timestamp\n      transactions (offset: $offset, limit: $limit) {\n        hash\n        from\n        to\n        value\n        gasPrice\n      }\n    }\n  }\n"): typeof import('./graphql').BlockTransactionsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query BlockTransactionsByHash($offset: Int, $limit: Int, $hash: String!) {\n    BlockTransactions: Ethereum__Mainnet__Block(filter: { hash: { _eq: $hash } }, limit: 1) {\n      timestamp\n      transactions (offset: $offset, limit: $limit) {\n        hash\n        from\n        to\n        value\n        gasPrice\n      }\n    }\n  }\n"): typeof import('./graphql').BlockTransactionsByHashDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query BlockByHash($hash: String!) {\n    Block: Ethereum__Mainnet__Block(filter: { hash: { _eq: $hash } }, limit: 1) {\n      hash\n      number\n      timestamp\n      parentHash\n      difficulty\n      totalDifficulty\n      gasUsed\n      gasLimit\n      baseFeePerGas\n      nonce\n      miner\n      size\n      stateRoot\n      sha3Uncles\n      transactionsRoot\n      receiptsRoot\n      logsBloom\n      extraData\n      mixHash\n    }\n  }\n"): typeof import('./graphql').BlockByHashDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query AttestationsCount($docId: String!) {\n    Attestation: Ethereum__Mainnet__AttestationRecord(filter: {attested_doc: {_eq: $docId}}) {\n        count: vote_count\n    }\n  }\n"): typeof import('./graphql').AttestationsCountDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query TransactionLogs($hash: String) {\n    Logs: Ethereum__Mainnet__Log(\n      filter: { transactionHash: { _eq: $hash } }\n      order: [{ logIndex: ASC }]\n    ) {\n      logIndex\n      address\n      topics\n      data\n      transactionHash\n      blockNumber\n    }\n  }\n"): typeof import('./graphql').TransactionLogsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
