...
many marketing landing pages and blog; and private part on /admin route that is provided by Payload CMS self-hosted version.
The tech stack includes Typescript and TailwindCSS. Nextjs's server functions are actively used. 

Follow the same coding patterns that exist in this project. Always check for repeated code and reuse it.
