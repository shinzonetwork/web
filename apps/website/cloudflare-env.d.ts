/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: a37cbb3c6d8f36abd9a685defda014d1)
// Runtime types generated with workerd@1.20260103.0 2025-12-03 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		NEXT_PUBLIC_PLAUSIBLE_DOMAIN: "shinzo.network" | "preview-staging.shinzo.network";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOW_INDEXING" | "NEXT_PUBLIC_PLAUSIBLE_DOMAIN" | "NEXT_PUBLIC_PLAUSIBLE_URL" | "CLOUDFLARE_ACCOUNT_ID" | "PAYLOAD_SECRET" | "NEXT_PUBLIC_URL" | "RESEND_API_KEY" | "GITHUB_TOKEN" | "AIRTABLE_API_KEY" | "AIRTABLE_INDEXER_FORM" | "AIRTABLE_SUGGEST_FORM">> {}
}
