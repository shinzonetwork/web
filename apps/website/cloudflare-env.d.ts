/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 0cae91a47c77c62a8ecc5c1be50747b6)
// Runtime types generated with workerd@1.20251217.0 2025-12-03 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		WORKER_SELF_REFERENCE: Fetcher /* shinzo-website-cmsdev */;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOW_INDEXING" | "CLOUDFLARE_ACCOUNT_ID" | "PAYLOAD_SECRET" | "NEXT_PUBLIC_URL" | "RESEND_API_KEY" | "GITHUB_TOKEN">> {}
}
