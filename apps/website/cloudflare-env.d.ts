/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 816b6cbfb06847425324a4a428cdbf28)
// Runtime types generated with workerd@1.20260508.1 2025-12-03 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		NEXT_PUBLIC_PLAUSIBLE_DOMAIN: "preview-staging.shinzo.network";
		NEXT_PUBLIC_PLAUSIBLE_URL: "https://plausible.source.network";
		CLOUDFLARE_ACCOUNT_ID: string;
		PAYLOAD_SECRET: string;
		RESEND_API_KEY: string;
		GITHUB_TOKEN: string;
		AIRTABLE_API_KEY: string;
		AIRTABLE_INDEXER_FORM: string;
		AIRTABLE_SUGGEST_FORM: string;
		...
		WORKER_SELF_REFERENCE: Fetcher /* shinzo-website-staging */;
	}
	interface Env {
		R2: R2Bucket;
		D1: D1Database;
		...
		NEXT_PUBLIC_PLAUSIBLE_DOMAIN: "preview-staging.shinzo.network" | "shinzo.network";
		NEXT_PUBLIC_PLAUSIBLE_URL: "https://plausible.source.network";
		CLOUDFLARE_ACCOUNT_ID: string;
		PAYLOAD_SECRET: string;
		RESEND_API_KEY: string;
		...
		RESEND_SEGMENT_ID: string;
		NEXT_CACHE_DO_QUEUE: DurableObjectNamespace<import("./.open-next/worker").DOQueueHandler>;
		WORKER_SELF_REFERENCE: Fetcher /* shinzo-website-staging */ | Service<typeof import("./.open-next/worker").default>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOW_INDEXING" | "NEXT_PUBLIC_PLAUSIBLE_DOMAIN" | "NEXT_PUBLIC_PLAUSIBLE_URL" | "CLOUDFLARE_ACCOUNT_ID" | "PAYLOAD_SECRET" | "RESEND_API_KEY" | "GITHUB_TOKEN" | "AIRTABLE_API_KEY" | "AIRTABLE_INDEXER_FORM" | "AIRTABLE_SUGGEST_FORM" | "NEXT_PUBLIC_WALLETCONNECT_ID" | "NEXT_PUBLIC_URL" | "RESEND_SEGMENT_ID">> {}
}
